      ...
      <div>
        ...
        {cartItems.map((item: any) => (
          <div key={item.id} style={{ margin: '20px' }}>
            ...
            <button type="button" onClick={() => handleAddProductToBasket(item)}>
              +
            </button>
            <button type="button" onClick={() => removeProductFromBasket(item)}>
              -
            </button>
            <br />
            <button type="button" onClick={() => deleteProductFromCart(item)}>
              delete
            </button>
